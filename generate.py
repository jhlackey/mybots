...
def Create_Robot():
    ...
    pyrosim.Send_Cube(name="FrontLeg", pos=[1,0,-.5] , size=[length,width,height])
    pyrosim.Send_Joint(name = "BackLeg_Torso" , parent= "Torso" , child = "BackLeg" , type = "revolute", position = [0,0,1])
